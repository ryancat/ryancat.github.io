...
var _Base2 = _interopRequireDefault(__webpack_require__(7));

var _ToolBox = _interopRequireDefault(__webpack_require__(9));
  ...
  _createClass(Editor, [{
    ...
    value: function listen() {
      ...
      this.aceEditor.session.on('change', function () {
        _this2.app.console.resultElement.innerHTML = '';
...
var _Editor = _interopRequireDefault(__webpack_require__(6));

var _Console = _interopRequireDefault(__webpack_require__(10));
    ...
    value: function listen() {
      ...
      this.inspectBtn.addEventListener('click', function () {
        ...
        try {
          ...
          _this2.console.resultElement.innerHTML = '<span class="result error">Your javascript code has error(s)</span>';
        }

        if (_this2.console.resultElement.innerHTML === '') {
          _this2.console.resultElement.innerHTML = '<span class="result">Result: ' + result + '</span>';
        }
      });
    }
  }]);
...
var _util = _interopRequireDefault(__webpack_require__(11));
